...
namespace Engine
{
    public class Sprite
    {
        ...
        public void SetMatrixPosition(Vector position)
        {
            Matrix m = new Matrix();
        ...
        public void SetMatrixScale(double x, double y)
        {
        ...
        public void SetMatrixRotation(double rotation)
        {
            double oldX = _positionX;
            double oldY = _positionY;
            SetPosition(0, 0);
